...
<body id="body">
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        header("Location: ../../index.php"); // Điều hướng về trang chính nếu không phải là POST
        exit();
    }
    ?>

    <form style="margin-top: 0.5cm;" id="regis_form" action="teacher_confirm.php" method="post" enctype="multipart/form-data">
        <?php
        $depart = array(
            "000" => "",
    ...
    <script>
        ...
        $.ajax({
            type: "GET",
            url: "../controllers/teacher_controller.php?id=" + teacher_id,
